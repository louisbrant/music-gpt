...
const MyofascialRelease: React.FC = () => {
  const mainService = "Myofascial Release";
  ...
  const serviceDetails = {
      ...
      description:
        "Whether you're an athlete or you sit at a desk all day, Myofascial Release is for you. A Muscle Lab Therapist will relieve your soreness one assisted stretch at a time.",
      benefit: "Myofascial Release Benefits",
      products: [
        {
          category: "Level",
          title: "Standard",
