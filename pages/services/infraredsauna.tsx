...
const InfraredSauna: React.FC = () => {
    const mainService = "Infrared Sauna";
    ...
    const serviceDetails = {
        ...
        description:
            "Whether you're an athlete or you sit at a desk all day, Infrared Sauna is for you. A Muscle Lab Therapist will relieve your soreness one assisted stretch at a time.",
        benefit: "Infrared Sauna Benefits",
        products: [
            {
                category: "Level",
                title: "Standard",
