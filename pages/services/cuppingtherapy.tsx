...
const CuppingTherapy: React.FC = () => {
  const mainService = "Cupping Therapy";
  ...
  const serviceDetails = {
      ...
      description:
        "Whether you're an athlete or you sit at a desk all day, Cupping Therapy is for you. A Muscle Lab Therapist will relieve your soreness one assisted stretch at a time.",
      benefit: "Cupping Therapy Benefits",
      products: [
        {
          category: "Level",
          title: "Standard",
