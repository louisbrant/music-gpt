export const RECOVERY_PLAN = 'recovery plan';
export const MORE_TIPS = 'more tips';
export const SUGGESTED_FOLLOW_UPS = 'sugggested follow-ups';
export const prompts = [
    {
        id: 1,
        content: 'Steps to achieve a balanced lifestyle including diet, exercise, and mental wellness'
    },
    {
        id: 2,
    ...
    {
        id: 3,
        content: 'Best practices for post-workout recovery'
    },
    {
        id: 4,
        content: 'Natural ways to strengthen the immune system'
    },
    {
        id: 5,
        content: 'How to improve sleep for better health and recovery'
    }
];
...
export const MUSCLELAB_URL = 'https://musclelab.la/';
